...
@RestController
@RequestMapping("/api/deleteExpiredAccounts")
public class DeleteExpiredAccountsController {
    public static final Logger log = LoggerFactory.getLogger(DeleteExpiredAccountsController.class);
